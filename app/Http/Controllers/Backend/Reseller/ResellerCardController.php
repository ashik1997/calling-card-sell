...
class ResellerCardController extends Controller
{
    ...
    public function add(Request $request){
        ...
        return view('reseller.reseller_card.add');
    }
    public function list(){
        $reseller_cards = ResellerCard::with('reseller','rate_plan','added_by')->where('added_by_id',Auth::user()->id)->paginate(10);
        return view('reseller.reseller_card.list')->with(compact('reseller_cards'));
    }
    public function edit(Request $request, $id){
        ...
        return view('reseller.reseller_card.edit')->with(compact('reseller_card'));
    }
    ...
    public function avialable_card(Request $request){
        if ($request->isMethod('post')) {
            return $card = User::my_card_stock(Auth::user()->id,$request->rate_plan_id);
        }
    }
}
