    ...
    <div class="col-md-6">
      ...
      <div class="card card-default">
          ...
          <div class="card-tools">
            <a href="{{route('reseller.reseller_payment.list')}}" class="btn btn-custom float-right"><i class="fa fa-arrow-left"></i> Back</a>
          </div>
      	</div>
      	<!-- /.card-header -->
      	@if ($errors->any())
        ...
        @endif
        <form action="{{ route('reseller.reseller_payment.add') }}" method="post" enctype="multipart/form-data">
        	@csrf
	        <div class="card-body">
            <div class="row">
              <div class="col-md-12">
