      ...
      <div class="card card-default">
        <div class="card-header bg-info">
          ...
          <div class="card-tools">
            <a href="{{route('reseller.reseller_balance.list')}}" class="btn btn-custom float-right"><i class="fa fa-arrow-left"></i> Back</a>
          </div>
        </div>
        <!-- /.card-header -->
        @if ($errors->any())
        ...
        @endif
        <form action="{{ route('reseller.reseller_balance.add') }}" method="post" enctype="multipart/form-data">
          @csrf
          <div class="card-body">
            <div class="row">
              <div class="col-md-12">
...
<script>
  ...
  function due_cal(){
    ...
    $.ajax({
     type: "POST",
     url: "{{route('reseller.due_balance_by_reseller_id')}}",
     dataType: 'json',
     data: {
      id:reseller_id,
      _token: csrf
