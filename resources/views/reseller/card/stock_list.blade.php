    ...
    <div class="col-md-4">
      <div class="card">
        ...
        <div class="card-footer">
	        <a href="{{route('reseller.card.sell',$rate_plan->id)}}?sell_rate_plan_id={{$_GET['sell_rate_plan_id']}}" class="btn btn-success btn-lg float-left"><i class="fa fa-shopping-bag"></i> Buy now</a>
	        <a href="" class="btn btn-info btn-lg float-right"><i class="fa fa-play"></i> Video</a>
        </div>
        <!-- /.card-footer -->
      </div>
      <!-- /.card -->
