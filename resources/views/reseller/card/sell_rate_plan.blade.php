    	...
    	<a href="{{route('admin.card.stock')}}?sell_rate_plan_id={{$sell_rate_plan->id}}" class="text-dark">
			<div class="card">
				<div class="card-header">
					<h3 class="card-title">{{$sell_rate_plan->currency}} 10 = {{$sell_rate_plan->amount}} tk</h3>
          ...
          <p>{!!$sell_rate_plan->description!!}</p>
				...
				<div class="card-footer">
					<a class="btn btn-success btn-block text-white" href="{{route('reseller.card.stock')}}?sell_rate_plan_id={{$sell_rate_plan->id}}">কার্ড কিনতে এখানে ক্লিক করুন </a>
				</div>
			</div>
			<!-- /.card -->
		</a>
