  ...
  <div class="row">
    <div class="col-md-6">
      ...
      <div class="card card-default">
        ...
        @endif
        <form action="{{ route('reseller.reseller_card.edit',$reseller_card->id) }}" method="post" enctype="multipart/form-data">
        	@csrf
	        <div class="card-body">
	        	<div class="row">
	        		<div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <select name="rate_plan_id" id="rate_plan_id" class="form-control" onchange="available_card()" required="required">
                  	<option value="">Select one</option>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="number" name="qty" id="qty" class="form-control" min="???" max="???" value="{{ $reseller_card->qty }}" placeholder="Enter qty">
                </div>
              </div>
              <!-- /.col -->
	        	</div>
