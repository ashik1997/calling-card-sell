      ...
      <div class="card">
        <div class="card-header bg-info">
          ...
          <div class="card-tools">
            <a href="{{route('reseller.reseller_card.add')}}" class="btn btn-custom float-right">Add New</a>
          </div>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
          <spna class="table-responsive">
            <table id="example2" class="table table-sm table-bordered">
              ...
              <tr>
                ...
                <td class="bt-group">
                  <!-- <a class="btn btn-primary btn-sm fa fa-edit" href="{{ route('reseller.reseller_card.edit',$reseller_card->id) }}"></a><a class="btn btn-danger btn-sm fa fa-trash-alt" href="{{ route('reseller.reseller_card.delete',$reseller_card->id) }}"></a> -->
                </td>
              </tr>
              @endforeach
              </tbody>
