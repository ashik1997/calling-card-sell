      ...
      <div class="card">
        <div class="card-header bg-info">
          ...
          <div class="card-tools">
            ...
            <a href="{{route('admin.reseller.all-list')}}" class="btn btn-success float-right">All Reseller</a>
          </div>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
            ...
            <table id="example1" class="table table-bordered table-sm">
              ...
              <tr>
                ...
                <td>
                  ...
                  Parent: {{App\Models\User::where('id', $reseller->added_by_id)->pluck('name')[0]}}
                </td>
