    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item"><a href="#">Reseller Card</a></li>
  ...
  <div class="row">
    <div class="col-md-6">
      ...
      <div class="card card-default">
        ...
        @endif
        <form action="{{ route('admin.reseller_card.add') }}" method="post" enctype="multipart/form-data">
        	@csrf
	        <div class="card-body">
	        	<div class="row">
	        		<div class="col-md-6">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="qty" id="qty" class="form-control" min="???" max="???" onkeyup="bill_cal()" value="{{old('qty')}}" placeholder="Enter qty">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
...
<script>
  ...
  function bill_cal(){
    ...
    $.ajax({
     type: "POST",
     url: "{{route('admin.get_rate_plan_by_id')}}",
     data: {
      id:rate_plan_id,
      _token: csrf
  ...
  function available_card(){
    ...
    $.ajax({
     type: "POST",
     url: "{{route('admin.available.card')}}",
     data: {
