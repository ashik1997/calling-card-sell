		        	...
		        	<div class="row">
		              <div class="col-md-4">
		                <div class="form-group">
		                  ...
		                  <input type="text" name="name" id="name" class="form-control" value="{{ $country->name }}" placeholder="Enter country name">
		                </div>
		              </div>
		              <div class="col-md-4">
		                <div class="form-group">
		                  <label for="mark">Mark</label>
		                  <input type="text" name="mark" id="mark" class="form-control" value="{{ $country->mark }}" placeholder="Most Popular">
		                </div>
		              </div>
		              <div class="col-md-4">
		                <div class="form-group">
		                  ...
		                  <br>
		                  <img src="{{asset('frontend/')}}/assets/img/country/{{ $country->flag }}" height="80" width="120" alt="">
		                </div>
		              </div>
		              <div class="col-md-4">
		                <div class="form-group">
		                  <label for="note">Note</label>
		                  <textarea name="note" id="note" class="form-control" placeholder="Enter note">{{ $country->note }}</textarea>
		                </div>
		                <!-- /.form-group -->
		              </div>
		              <!-- /.col -->
