      ...
      <div class="card">
        <div class="card-header bg-success">
          ...
          <div class="card-tools bg-success">
            ...
            <a href="{{route('admin.card.sell_rate_plan')}}" class="btn btn-primary btn-sm"><i class="fa fa-shopping-bag"></i> New Buy</a>
          </div>
          </div>
        </div>
        <!-- /.card-header -->
					...
					<div class="row" id="printableArea">
						...
						<div class="col-md-12">
							<div class="card card-body">
								...
								User: {{$card->user}}<br>
								Pass: {{$card->pin}}<br>
								Using video link: <a href="https://youtu.be/FgMeL9gbN2g">https://youtu.be/FgMeL9gbN2g</a><br>
								Android dailer: <a href="https://shopontel.net/dailler/1">https://shopontel.net/dailler/1</a><br>
								ISO dailer: <a href="https://shopontel.net/dailler/2">https://shopontel.net/dailler/2</a><br>
								Windows dailer: <a href="https://shopontel.net/dailler/3">https://shopontel.net/dailler/3</a><br>
                UAE dailer: <a href="https://shopontel.net/dailler/4">https://shopontel.net/dailler/4</a><br>
                Piyofon express: <br>no need<br><br>
                iTel Mobile dialer: <br>64244
							</div>
						</div>
					</div>
					<div class="row">
